...
import { increament,decreament} from'./Redux/Reducers/tasks.reducer'
                    ...
                    <div className="card-body px-3">
                        ...
                        <div className="d-flex justify-content-between align-items-center">
                          ...
                          <div className="d-flex flex-row justify-content-between align-items-center">
                            <button
                              ...
                              onClick={() => {
                                dispatcher(decreament());
                              }}
                            >
                              {" "}
                              -{" "}
                            </button>
                            <div className="py-1 quantityText">{tasksReducer.Count}</div>
                            <button
                              type="button"
                              className="btn btn-outline-success"
                              style={{ marginLeft: "8px" }}
                              onClick={() => {
                                dispatcher(increament());
                              }}
                            >
                              {" "}
                              +{" "}
                      ...
                      <div className="bottom">
                        ...
                        <div className="d-flex justify-content-between align-items-center">
                          ...
                          <h5 className="card-text">${e.price * tasksReducer.Count }</h5>
                        </div>
                      </div>
                      <button
                        type="button"
